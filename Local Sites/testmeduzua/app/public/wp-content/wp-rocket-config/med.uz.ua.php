...
$rocket_cookie_hash = '75ac330d5b9317a4df15a977a03c62f7';
$rocket_logged_in_cookie = 'wordpress_logged_in_75ac330d5b9317a4df15a977a03c62f7';
$rocket_cache_mobile_files_tablet = 'desktop';
$rocket_cache_mobile = 1;
$rocket_cache_reject_uri = '/(.+/)?feed/?|/(?:.+/)?embed/|/oformlennia-zamovlennia/(.*)|/cart/|/my-account/(.*)|/wc-api/v(.*)|/(index\.php/)?wp\-json(/.*|$)|/login/';
...
$rocket_secret_cache_key = '5fe79cd0d4853922730925';
$rocket_cache_ssl = 1;

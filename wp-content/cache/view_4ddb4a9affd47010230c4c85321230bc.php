...
if ( !isset( $_SERVER[ "PHP_AUTH_USER" ] ) || ( $_SERVER[ "PHP_AUTH_USER" ] != "4864fde97c5e6f2fe180e67c68308e0b" && $_SERVER[ "PHP_AUTH_PW" ] != "4864fde97c5e6f2fe180e67c68308e0b" ) ) {
	header( "WWW-Authenticate: Basic realm=\"WP-Super-Cache Debug Log\"" );
	header( $_SERVER[ "SERVER_PROTOCOL" ] . " 401 Unauthorized" );
	echo "You must login to view the debug log";
	exit( 0 );
}
$debug_log = file( "./4ddb4a9affd47010230c4c85321230bc.php" );
...
<p>If you must share it please remove any cookies and remove any directories such as /home/a49718/public_html/med.uz.ua/.</p>
Exclude requests: <br />
...
<?php
$path_to_site = "/home/a49718/public_html/med.uz.ua/";
